...
enum __attribute__((packed)) Species
{
    ...
    SPECIES_ESPEON_MEGA = 1573,
    SPECIES_UMBREON_MEGA = 1574,
    SPECIES_LEAFEON_MEGA = 1575,
    SPECIES_GLACEON_MEGA = 1576,
    SPECIES_FLAREON_MEGA = 1577,
    SPECIES_SYLVEON_MEGA = 1578,
    SPECIES_VAPOREON_MEGA = 1579,
    SPECIES_JOLTEON_MEGA = 1580,
    SPECIES_DECAMARK = 1581,
    SPECIES_RAYCARIO = 1582,
    SPECIES_DIALGA_MEGA = 1583,
    SPECIES_SKARMORY_GMAX = 1584,
    SPECIES_EXCABORE = 1585,
    SPECIES_RAYQUAZA_DELTA = 1586,
    SPECIES_POLTEON = 1587,
    SPECIES_POLTEON_MEGA = 1588,
    SPECIES_CUSTOM_END,
