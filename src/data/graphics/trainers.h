...
const u32 gTrainerFrontPic_Hexadec_Maniac[] = INCGFX_U32("graphics/trainers/front_pics/Hexadec_Maniac.png", ".4bpp.smol");
const u16 gTrainerPalette_hexadec_maniac[] = INCGFX_U16("graphics/trainers/palettes/hexadec_maniac.pal", ".gbapal");

const u32 gTrainerFrontPic_Doctor[] = INCGFX_U32("graphics/trainers/front_pics/doctor.png", ".4bpp.smol");
...
const struct TrainerPicInfo gTrainerPicInfo[TRAINER_PIC_COUNT] =
{
    ...
    [TRAINER_PIC_HEXADEC_MANIAC] =
    {
        .frontPic = TRAINER_FRONT_PIC(gTrainerFrontPic_Hexadec_Maniac, gTrainerPalette_hexadec_maniac),
    },
    [TRAINER_PIC_DOCTOR] =
    {
        .frontPic = TRAINER_FRONT_PIC(gTrainerFrontPic_Doctor, gTrainerPalette_LeaderGiovanniFrlg),
    },
};
